...
#ifndef RENAMEBLOCKCOMMAND_H
#define RENAMEBLOCKCOMMAND_H
...
namespace ysm
{
	//! \brief Command that renames pipeline items.
	class RenamePipelineItemCommand : public UIDataChangingCommand
	{
	public:
		 ...
		 */
		RenamePipelineItemCommand(IPipelineItem* item, const QString& name);
	...
	private:
		...
		//! \brief Pipeline item to rename.
		IPipelineItem* _pipelineItem;

		//! \brief Old and new name.
		QString _targetName;
	};
}
