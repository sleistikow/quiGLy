...
namespace ysm
{
	class DeleteRenderCommandsCommand;

	//! \brief Command that deletes one or more blocks.
	class DeleteBlocksCommand : public UIDataChangingCommand
	{
	public:
		 ...
		 */
		DeleteBlocksCommand(IPipeline* pipeline, IBlock* block);

		/*!
		 * \brief Initialize new instance.
		 * \param pipeline The pipeline to operate on.
		 * \param block The blocks to delete.
		 */
		DeleteBlocksCommand(IPipeline* pipeline, QList<IBlock*> blocks);
		 ...
		 * \param block The blocks to delete.
		 */
		DeleteBlocksCommand(IPipeline* pipeline, QVector<IBlock*> blocks);
	...
	private:
		...
		//! \brief The deleted blocks.
		QList<IBlock*> _blocks;
