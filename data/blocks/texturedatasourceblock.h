...
#ifndef TEXTUREDATASOURCEBLOCK_H
#define TEXTUREDATASOURCEBLOCK_H
...
{
	/**
	 * @brief Base for texture blocks (images, KTX files etc.)
	 */
	class TextureDataSourceBlock : public DataSourceBlock
	{
		Q_OBJECT

	public:
		// Construction
		explicit TextureDataSourceBlock(DataSource* dataSource, Pipeline* parent, BlockType type, const QString& name);
