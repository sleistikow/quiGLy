...
#ifndef SHADERBLOCKEVALUATOR_H
#define SHADERBLOCKEVALUATOR_H

#include "blockevaluator.h"

namespace ysm
{
	class ShaderBlockEvaluator : public BlockEvaluator
	{
	public:
		ShaderBlockEvaluator(SetupRenderingEvaluator* evaluator);
