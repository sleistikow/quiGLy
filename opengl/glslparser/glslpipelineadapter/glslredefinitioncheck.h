...
#ifndef GLSLGLOBALREDEFINITIONCHECK_H
#define GLSLGLOBALREDEFINITIONCHECK_H
...
namespace ysm
{
	...
	//! \brief Checks for global scope redefinitions.
	class GLSLRedefinitionCheck : public IGLSLPipelineCheck
	{
	public:
	...
	protected:
		...
		/*!
		 * \brief Checks the given code block for redefinitions.
		 * \param codeBlock The code block.
		 * \param parentDeclarations Declarations contained by the parent.
		 */
		void checkCodeBlock(GLSLCodeBlock* codeBlock, QMap<QString, GLSLDeclaration*> parentDeclarations);
	};

}

#endif // GLSLGLOBALREDEFINITIONCHECK_H
