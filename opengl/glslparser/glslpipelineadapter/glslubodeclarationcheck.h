...
#ifndef GLSLUBODECLARATIONCHECK_H
#define GLSLUBODECLARATIONCHECK_H
...
namespace ysm
{
	...
	//! \brief Checks the UBO integrity between a shader block and it's GLSL code.
	class GLSLUBODeclarationCheck : public GLSLDeclarationCheck<IConnection*, GLSLUBODeclarationCheck>
	{
	private:
...
#endif // GLSLUBODECLARATIONCHECK_H
