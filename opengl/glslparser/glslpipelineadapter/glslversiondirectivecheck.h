...
#ifndef GLSLVERSIONDIRECTIVECHECK_H
#define GLSLVERSIONDIRECTIVECHECK_H
...
namespace ysm
{
	...
	//! \brief Checks the integrity between GLSL version and project version.
	class GLSLVersionDirectiveCheck : public IGLSLPipelineCheck
	{
	public:
...
#endif // GLSLVERSIONDIRECTIVECHECK_H
