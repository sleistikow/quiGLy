...
#ifndef CLEARCOMMANDPROPERTYVIEW_H
#define CLEARCOMMANDPROPERTYVIEW_H
...
namespace ysm
{
    ...
    class ClearCommandPropertyView : public PipelineItemPropertyView
    {
        Q_OBJECT
    public:
         ...
         */
		ClearCommandPropertyView(IPipelineItem* pipelineItem, QWidget* parentWidget, IView* parentView);
    };
}
#endif // CLEARCOMMANDPROPERTYVIEW_H
