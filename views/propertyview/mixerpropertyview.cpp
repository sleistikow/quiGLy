...
#include "mixerpropertyview.h"
#include "propertyviewfactory.h"
#include "propertyviewitems/mixerlayoutpropertyviewitem.h"

using namespace ysm;

void MixerPropertyView::registerPropertyItems(PropertyViewFactory* factory)
{
...
MixerPropertyView::MixerPropertyView(IPipelineItem* pipelineItem, QWidget* parentWidget, IView* parentView) :
	PipelineItemPropertyView(pipelineItem, parentWidget, parentView)
{
	//Register additional group for the layout.
	setPropertyGroup(pipelineItem->getProperty<MixerLayoutProperty>(PropertyID::Mixer_Layout), "Layout");
}
