...
namespace ysm
{
	//! \brief Dropdown for enumeration properties.
	class EnumPropertyViewItem : public GenericPropertyViewItem<EnumProperty, int>
	{
		Q_OBJECT
	...
	public:
		 ...
		 */
		explicit EnumPropertyViewItem(IProperty* property, IView* parentView);
