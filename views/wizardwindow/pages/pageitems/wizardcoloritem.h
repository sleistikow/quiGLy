...
#ifndef WIZARDCOLORITEM_H
#define WIZARDCOLORITEM_H
...
namespace ysm
{
	...
	class WizardColorItem : public WizardDynamicItem
	{
		Q_OBJECT
	...
	public:
		 ...
		 */
		WizardColorItem(WizardItemCollection* collection, QDomElement element, QFormLayout* layout);
